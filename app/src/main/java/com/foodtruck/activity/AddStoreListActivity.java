...
public class AddStoreListActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_store_list);
        ...
        findViewById(R.id.btn_add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddStoreListActivity.this, AddTruckActivity.class);
    ...
    private void requestData() {
        ...
        RequestApi.getInstance().getTruckList(new NetworkResponse<StoreListVo>() {
            ...
            public void onFail(Call call, String msg) {
                Toast.makeText(AddStoreListActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deleteAlert(final StoreVo item) {
        new AlertDialog.Builder(AddStoreListActivity.this)
    ...
    private void deleteTruck(final StoreVo item) {
        RequestApi.getInstance().deleteTruck(item.get_id(), new NetworkResponse() {
            ...
            public void onSuccess(Call call, Object clazz) {
                Toast.makeText(AddStoreListActivity.this, "삭제 되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    private void showModifyDialog(final StoreVo item) {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("뎃글", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(AddStoreListActivity.this, AddReplyActivity.class);
                ...
                .setNegativeButton("메뉴", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(AddStoreListActivity.this, AddMenuActivity.class);
                        intent.putExtra("data", item);
                        intent.putExtra("truck_id", item.get_id());
                        startActivity(intent);
                ...
                .setNeutralButton("설명", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(AddStoreListActivity.this, AddTruckInfoActivity.class);
                        intent.putExtra("data", item);
                        intent.putExtra("truck_id", item.get_id());
                        startActivity(intent);
                    }
    ...
    public class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_store_add_list, parent, false);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            Glide.with(AddStoreListActivity.this)
